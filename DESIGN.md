...
The test device separates volatile bytes, durable bytes, and pending writes. Most tests use it; real file durability tests are opt-in and intentionally scarce.
